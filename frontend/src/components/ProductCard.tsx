...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Link href={`/products/${productDetails.Slug}`} passHref>
      <div
        className={`bg-white p-6 rounded-lg shadow-lg max-w-product-card mx-auto relative transition-transform duration-200 ease-in-out hover:ring-2 hover:ring-black-400 ${
